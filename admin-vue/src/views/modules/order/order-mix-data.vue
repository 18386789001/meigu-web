<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <el-form-item label="当前成交价格" prop="currentPrice">
        <el-input v-model="dataForm.currentPrice" type="number" placeholder="当前成交价格（非必填）"></el-input>
      </el-form-item>
    ...
    methods: {
      ...
      dataFormSubmit: Debounce(function () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: 'https://jpmx.xyz/apis/exchangeApplyOrder/success',
              method: 'post',
              data: {

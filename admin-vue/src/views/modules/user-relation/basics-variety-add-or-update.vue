      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="证件正面照" prop="methodImg">
            ...
            >
              <img v-if="idFrontImg" :src="idFrontImg" class="avatar" referrerpolicy="no-referrer" @click.stop="openInNewTab(idFrontImg)" />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
            <el-button v-if="idFrontImg" type="primary" @click="preview(idFrontImg)" plain size="small">预览</el-button>
            <el-button v-if="idFrontImg" @click="openInNewTab(idFrontImg)" size="small">打开</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="证件背面照" prop="methodImg">
            ...
            >
              <img v-if="idBackImg" :src="idBackImg" class="avatar" referrerpolicy="no-referrer" @click.stop="openInNewTab(idBackImg)" />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
            <el-button v-if="idBackImg" type="primary" @click="preview(idBackImg)" plain size="small">预览</el-button>
            <el-button v-if="idBackImg" @click="openInNewTab(idBackImg)" size="small">打开</el-button>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="手持正面照" prop="methodImg">
            ...
            >
              <img v-if="handheldPhoto" :src="handheldPhoto" class="avatar" referrerpolicy="no-referrer" @click.stop="openInNewTab(handheldPhoto)" />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
            <el-button v-if="handheldPhoto" type="primary" @click="preview(handheldPhoto)" plain size="small">预览</el-button>
            <el-button v-if="handheldPhoto" @click="openInNewTab(handheldPhoto)" size="small">打开</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    getDesc(uuid) {
      this.$http({
        ...
        if (data.code == 0) {
          ...
          this.idFrontImg = (this.dataForm.idFrontImg || '').trim();
          this.idBackImg = (this.dataForm.idBackImg || '').trim();
          this.handheldPhoto = (this.dataForm.handheldPhoto || '').trim();
        } else {
          this.$message({
            message: data.msg,
            type: "error",

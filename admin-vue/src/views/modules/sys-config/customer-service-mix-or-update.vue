<template>
  ...
  >
    ...
    >
      ...
      <el-form-item v-if="val == 2" label="新密码二次确认" prop="confirmPassword">
        <el-input
      ...
      <el-form-item v-if="val == 3" label="新资金密码二次确认" prop="confirmSafePassword">
        <el-input
          v-model="dataForm.confirmSafePassword"
          type="password"
...
export default {
  data() {
    return {
      ...
      dataRule: {
        ...
        confirmSafePassword: [
          { required: true, message: "请再次输入资金密码", trigger: "blur" },
          {
            validator: (rule, value, callback) => {
              if (value !== this.dataForm.safePassword) {
  ...
  methods: {
    init(val, row, m) {
      ...
      this.dataForm.safePassword = "";
      this.dataForm.confirmSafePassword = "";
      this.dataForm.loginSafeword = "";
      this.dataForm.superGoogleAuthCode = "";

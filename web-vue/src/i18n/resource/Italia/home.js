export default {
  ...
  selectReason: "Ecco alcuni motivi per cui dovresti scegliere Coinstore",
  ...
  reasonTitle2Tips:
    "Coinstore mantiene un'assicurazione crittografica e tutti i saldi in contanti in USD sono assicurati FDIC fino a $ 250.000. ",
  reasonTitle3: "Best practice del settore",
  reasonTitle3Tips: "Coinstore supporta molte delle valute digitali più popolari. ",
  ...
  changsuo:
    "Coinstore ha una varietà di caratteristiche che lo rendono il posto migliore per iniziare a fare trading",
  kaishichuangjian: "Crea subito il tuo portafoglio di criptovalute",
  baomingkaishi:
    "Coinstore è il posto più semplice per acquistare e vendere criptovalute. Iscriviti e inizia oggi. ",
  ...
  jiamizhilv_1:
    "Coinstore, la più grande piattaforma di scambio di criptovalute al mondo, consente agli investitori di condurre transazioni di investimento in modo sicuro e sicuro.",
  ...
  touzizuhe_2:
    "Coinstore ha molte funzioni, che lo rendono il posto migliore per iniziare a fare trading",
  ...
  huobipingtai_2: "Ecco alcuni motivi per cui dovresti scegliere Coinstore",
  ...
  huobipingtai_6:
    "Coinstore mantiene un'assicurazione di crittografia e tutti i saldi in dollari sono coperti da un'assicurazione FDIC, fino a 250000 dollari.",
  huobipingtai_7: "Best Practice del settore",
  huobipingtai_8: "Coinstore supporta molte delle valute digitali più popolari.",
  ...
  wenxintishi_0:
    "谨防冒用Coinstore官方人员的电话、邮箱诈骗： 随着数字货币交易被越来越多的人所知，非法分子也利用它进行诈骗等行为。随着近期非法分子的骗术升级，越来越多的“骗术”层出不穷。我们在此提醒广大用户对于这些防不慎防的骗术需要仔细甄别，避免资金损失。由于区块链转账的不可逆和用户信息的匿名，一旦发生对应的转账或账户信息被攻破，您的资金或将无法追回！ ",
  wenxintishi_1:
    "Beware of fraudulent use of the phone and email address of Coinstore official staff",
  ...
  wenxintishi_8:
    "Such as fraudulent activities in the name of Coinstore staff, including calling users in the name of Coinstore customer service or Coinstore staff, adding contact information, and attracting users to enter fake chat groups. Typical scams also include the following means:",
  wenxintishi_9:
  ...
  wenxintishi_11:
    'Fake Coinstore official account to create a group, conduct fraud in the name of replacement, gift, and other activities, and claim to be the so-called "official" Coinstore account.',
  wenxintishi_12:
    "Identify fraud methods: Coinstore information will be released by Coinstore official website. If there is no official website website activity, please do not be deceived. If you have any questions, please contact the online customer service as soon as possible to avoid being cheated!",
  wenxintishi_13:
    "Security Reminder: Any platform and staff of judicial and public security agencies will not actively contact you on the grounds that your account is at risk, ask you for any password, verification code information, and will not ask you to perform asset transfer operations such as buying coins/transfers . For any Coinstore-related information update, please pay attention to the Coinstore announcement, carefully screen out fraudulent activities, and avoid loss of funds. In addition, the official customer service of the Coinstore platform will not contact users by phone. We only have online customer service and whatspp specialists are communication tools for Coinstore to contact users.",
  wenxintishi_14:
    "For specific contact methods, please refer to: How to use Coinstore online customer service system to obtain further support. If you are involved in fund-related issues, please consult customer service as soon as possible.",
  ...
  yinsibaohu_13:
    "4.1 When you use this website, you agree that we start using Coinstore exchange to track your every move, collect and remember all the information you leave, including but not limited to your IP address, geographical location and other information.",
  yinsibaohu_14:
  ...
  yinsibaohu_22: "5. Coinstore Exchange",
  yinsibaohu_23:
    "5.1 We use Google Stats through the Coinstore exchange to record our performance and check the effectiveness of online advertising when you visit our website. An Coinstore exchange is a small amount of data sent to your browser and stored on your computer's hard drive. Coinstore exchanges are only sent to your computer's hard drive when you use a computer to access our website.",
  yinsibaohu_24:
    "5.2 Coinstore Exchange is generally used to record the habits and preferences of visitors when browsing various items on our website. The information collected by the Coinstore exchange is anonymous collective statistics and does not contain personal information.",
  yinsibaohu_25:
    "5.3 Coinstore Exchange cannot be used to obtain data on your hard drive, your email address and your private data. They allow this website or service provider's systems to recognize your browser and capture and remember information. Most browsers are preset to accept the Coinstore exchange. You can choose to set your browser not to accept Coinstore Exchange, or to notify you as soon as Coinstore Exchange is installed. However, if you set to block Coinstore Exchange, you may not be able to activate or use certain features of our website.",
  ...
  yinsibaohu_56:
    "10.1 If you have any requirements and comments, you can send an email to Coinstore@Coinstore.com, this is the only valid official email address we communicate with you, so we do not use effective contact information for you, and we will not be responsible for any actions or failures .",
  yinsibaohu_57:
  ...
  licai_1: "Gestione fondi Coinstore, dedicata a migliorare il reddito degli utenti",
  licai_2: "Usa valuta digitale inattiva per guadagnare entrate extra",
  kuangchi_1:
    "Coinstore gestione finanziaria del mining pool, è così semplice aumentare le entrate",

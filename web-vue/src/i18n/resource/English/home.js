export default {
  ...
  yinsibaohu_56:
    "10.1 If you have any requirements and comments, you can send an email to support{'@'}Coinstore.com, this is the only valid official email address we communicate with you, so we do not use effective contact information for you, and we will not be responsible for any actions or failures .",
  yinsibaohu_57:

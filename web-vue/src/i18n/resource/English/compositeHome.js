export default {
  ...
  "h-s2-1-d1":
    "Live prices are for indicative purposes only. Check your platform for the latest prices. Powered by Coinstore Markets Limited.",
  ...
  "h-s3-d1":
    "Coinstore ATP Rankings Global Title Partner and Official Online Trading Partner of the ATP Tour.",
  ...
  "h-s7-d1":
    "Coinstore is honored to be named Broker of the Year at the TradingView Broker Awards",
  ...
  "ready-d3":
    "Opening a Coinstore account is easy. It only takes a few minutes to start your Coinstore journey.",
  "ready-d4":
  ...
  "header-s-s1-q1": "What account types does Coinstore offer?",
  ...
  "header-s-s1-q3": "Is Coinstore an ECN/STP trader or a market maker?",
  ...
  "header-s-s1-a3": `<div class="rich-text__container"><h5>We get asked this question a lot. Part of the difficulty in answering this question is that ECN and STP are marketing terms taken from the listing market regime, and are given different meanings by different providers in the industry. </h5>
   ...
   <h5>For more information on this, please contact <a href="mailto:support@Coinstore.com">support@Coinstore.com</a>. </h5></div>`,
  ...
  "header-rf-s0-d1":
    "Introducing Coinstore's Friend Referral Program to retail and Coinstore Pro customers. Terms and conditions apply to this offer.",
  "header-rf-s1-t1": "A friend referral program tailored for you",
  "header-rf-s1-d1":
    "We offer two refer-a-friend programs, depending on whether you are a professional client (Coinstore Pro) or a retail client. Our refer-a-friend program is designed to reward clients who invite family or friends to trade with us.",
  "header-rf-s1-h1": "For retail customers",
  "header-rf-s1-h2": "For Coinstore Pro customers",
  "header-rf-s1-r1":
  ...
  "header-rf-s2-q1": "How do I become a Coinstore Pro?",
  "header-rf-s2-a1":
    "If you are not yet a Coinstore Pro but are interested in becoming a professional trader, you can find more information on eligibility criteria and requirements here.",
  "header-rf-s2-q2": "How can your friends get recommendations?",
  "header-rf-s2-a2":
    "When you start recommending Coinstore to your friends, your friends have to be in 'How did you hear about us?' when they sign up for the application?  Fill in your email.",
  ...
  // "header-rf-s3-tip2":``,
  // footer
  "footer-s1-1-t1": "Coinstore Markets Ltd",
  "footer-s1-1-d1": "Why choose Coinstore",
  ...
  "m1-LEI-s2-5-d1":
    "If you have any questions about obtaining an LEI, please contact support{'@'}Coinstore.com",
  // m1-award
  ...
  "m1-vip-s1-4":
    "If you are a Coinstore professional client, get access to premium event invitations, advanced trading tools and VPS solutions",
  ...
  "m1-vip-s3-d1":
    "To qualify as our Premium Client, we require that you meet one or more of the following thresholds for two consecutive calendar quarters. Retail and Coinstore Pro customers qualify as Premium Clients.",
  ...
  "m1-vip-s4-2-d1":
    "Earn discounted commissions that are paid back daily when you qualify for Coinstore's ActiveTrader program.",
  "m1-vip-s4-3-t1": "Advanced Event",
  "m1-vip-s4-3-d1":
    "For professional clients of Coinstore, exclusive access to VIP premium FX events, seminars and workshops, private dining experiences and invitations to sporting events.",
  "m1-vip-s5-t1": "Consult Now",
  "m1-vip-s5-d1":
    "For more information or to join our Premium Client Service  email support{'@'}Coinstore.com.",
  "m1-vip-s5-d2":
  ...
  "m1-at-s3-2-d1":
    "For Coinstore Pro customers, a free VPS hosting solution to run automated policies and leverage our low-latency EDGE infrastructure.",
  "m1-at-s3-3-t1": "Advanced Insights and Reports",
  "m1-at-s3-3-d1":
    "Exclusive insights from Coinstore market analysts, daily Autochartist signals and all the MT4 and MT5 features and trade reports you'd expect from an award-winning broker.",
  ...
  "m1-who-s0-d1":
    "Coinstore knows how to trade. With the scale of a global fintech and the agility of a start-up, we are here to provide you with everything you need to trade in global markets.",
  "m1-who-s1-t1": "Our History",
  "m1-who-s1-d1":
    "Coinstore Exchange is a global digital asset financial services platform, registered in the British Virgin Islands (BVI), and officially registered as an MSB (Money Services Business) with the US FinCEN (Financial Crimes Enforcement Network) and Canada's FINTRAC (Financial Transactions and Reports Analysis Centre), conducting financial and monetary services business in compliance with the law. Since its establishment, the platform has always adhered to the development philosophy of 'compliance first, security as the foundation, innovation-driven', and is committed to providing global users with a safe, intelligent, fair, and transparent digital asset investment environment.",
  ...
  "m1-who-s6-d1":
    "*Active users^registered Coinstore account holders who opened trades or held positions between July 1, 2019 and November 30, 2019",
  // m1-why
  "m1-why-s1-t1": "Why choose Coinstore?",
  "m1-why-s1-d1":
  ...
  "m1-why-s2-d1":
    "Coinstore was founded in 2010 and has rapidly grown into one of the world's largest foreign exchange brokers. Our goal is to build a trading world with advanced technology at its core, so that passionate traders can face the challenges brought by the global market and opportunities",
  ...
  "m1-why-s4-t1": "Why trade with Coinstore?",
  ...
  "m1-why-s5-d8": `Earn cash on high volume trades with our <a href="/#/why-Coinstore/active-trader-program">Active"Trader program</a> rebate.`,
  "m1-why-s5-d9":
  ...
  "m1-why-s7-3":
    "*Most orders were executed in less than 30 ms (Coinstore Group Limited) and 60 ms (Coinstore Limited) based on the processing time received by the Coinstore bridge.",
  "m1-why-s7-1":
  ...
  "m2-product-1-s2-t1": "Why trade forex with Coinstore?",
  "m2-product-1-s2-d1":
  ...
  "m2-product-2-s2-t1": "Why trade index CFDs at Coinstore?",
  "m2-product-2-s2-d1":
  ...
  "m2-product-3-s2-t1": "Why trade commodity CFDs at Coinstore?",
  "m2-product-3-s2-d1":
  ...
  "m2-product-4-s2-t1": "Why trade ETF CFDs with Coinstore?",
  "m2-product-4-s2-d1":
  ...
  "m2-product-4-s4-d1":
    "Trading ETF CFDs with Coinstore means you trade at the direct underlying exchange price without adding additional spreads to the bid-ask spread. However, you will pay a small commission per trade. Details are as follows:",
  ...
  "m2-product-5-s2-t1": "Why trade stock CFDs with Coinstore?",
  "m2-product-5-s2-d1":
  ...
  "m2-product-5-s6-d1":
    "Our share CFDs can be traded with leverage on MetaTrader 5. To add a share CFD to your trading portfolio, please open a Coinstore MetaTrader 5 account and select the corresponding share CFD from Market Watch.",
  "m2-product-5-s6-d2":
  ...
  "m2-product-6-s2-t1": "Why trade cryptocurrencies with Coinstore?",
  "m2-product-6-s2-d1":
  ...
  "m2-product-6-s4-d1":
    "Cryptocurrencies such as Bitcoin are more volatile than traditional currencies and carry significant risk. Please also note that when you trade with Coinstore, you will not own the underlying currency or have any rights in that base currency. The cryptocurrency market is volatile and sudden price movements can cost you a lot of money very quickly.",
  "m2-product-6-s4-d2":
  ...
  <h4 class="mt-4"><strong>Where can I find Coinstore's swap rate information? </strong></h4>
...
This extra trading session over the weekend not only means you have more time to speculate on the prices of different tokens, but any stops and take profits you have attached can be covered over the weekend. `,
  ...
  "m2-fw-s1-d1":
    "Managing your account on our platform is very simple. As a Coinstore client, you have access to your own encrypted client where you can perform all deposit and withdrawal needs securely.",
  ...
  "m2-fw-s2-d2":
    "Due to third-party trading regulations, funds can only be returned to a bank account in the same name (or joint name) as your Coinstore trading account",
  "m2-fw-s2-d3":
  ...
  "m3-i-s2-1-d1":
    "Connect to TradingView directly from your Coinstore trading account with our cTrader powered integration. A powerful charting tool",
  ...
  "m3-mt4-s4-d1":
    "Whatever your technical level, MT4 can give you a competitive advantage. The platform provides a rich, user-friendly interface in a highly customizable trading environment that helps improve your trading performance. MT4 is free to download, Available on our Coinstore and live accounts.",
  ...
  <ul><li><a href="javascript:void(0)">Coinstore MetaTrader 4 User Guide eBook</a></li><li><a href="javascript:void(0)" ">Coinstore MetaTrader 4 Error Codes Guide</a></li></ul></div>`,
  "m3-mt4-s5-d1":
    "If you want to learn more about trading via the MT4 platform, simply download the guide below or watch our MT4 video.",
  "m3-mt4-s5-l1": "Coinstore MetaTrader 4 User Guide eBook",
  "m3-mt4-s5-l2": "Coinstore MetaTrader 4 Error Code Guide",
  ...
  <ol><li>Copy and paste the password (make sure you are not using any spaces)</li><li>Manually enter your server IP address</li><li>Backspace server and manually enter the server IP address'edge&lt ;Server ID&gt;.Coinstore.com'. For example, Edge 03 = edge03.Coinstore.com</li></ol>
  ...
  "m3-mt4-s7-a7": `<div class="rich-text__container"><h6><strong>What is the difference between MT4 and MT5?</strong></h6>
    ...
    <h6>In addition to these add ons, Coinstore here in Australia has its own affiliations with companies such as myFXBook, Duplitrade and Zulutrade who offer social trading solutions that are easy to set up, and give the users control over what they choose to invest their money in.</h6>
    ...
    <h6><strong>Contrary to popular belief though, MT5 has not been built to replace MT4.</strong> It’s here to supplement it. Here at Coinstore, our investors use both MT4 and MT5 and get the best of both worlds and we support their trading approaches with online resources, access to webinars and of course, 24/5 support.</h6>
  ...
  "m3-st-mf-s3-1":
    "Carefully screened system whose success is tested for trading with real money, not a Coinstore account",
  "m3-st-mf-s3-2":
  ...
  "m3-st-mf-s4-1-t1": "Step 1 - Create your Coinstore trading account",
  "m3-st-mf-s4-1-q1": "New to Coinstore?",
  "m3-st-mf-s4-1-a1":
    "1. Fill out the online Coinstore trading account application</br> 2. Register for AutoTrade",
  ...
  "m3-st-mf-s4-2-t1":
    "Step 2 - Connect your Coinstore trading account to Myfxbook AutoTrade",
  "m3-st-mf-s4-2-a1":
    "1. The next stage is to visit the Myfxbook website and connect your Coinstore trading account to Myfxbook AutoTrade</br>2. Connect the account",
  "m3-st-mf-s5-d1":
    "Disclaimer: The AutoTrade system is owned and operated by Myfxbook Ltd (Myfxbook) and its use is subject to the terms and conditions stated on its website http://www.myfxbook.com/terms. Coinstore Group Limited (Coinstore) is not responsible for, and has no control over, the use of signals generated by AutoTrade and resulting Coinstore account transactions. Signals generated by AutoTrade on Coinstore accounts do not constitute factual, general or personal advice by Coinstore.",
  "m3-st-mf-s5-d2":
    "Important Disclaimer: The information and analysis presented here has been produced by Signal Provider, Inc. Coinstore has reproduced this information without alteration or verification and does not represent that this material is accurate, current or complete and should not be relied upon This information. This material is general information and is for informational purposes only and does not take into account any individual's investment objectives, financial solutions or approaches. Coinstore advises clients to seek independent financial advice before considering investing in any signal products and services. In addition, Coinstore reiterates that, Past returns are not indicative of future performance. Readers should also be aware that, like all technological applications, the Internet has inherent weaknesses and operating systems rely on third parties to manage connections to Coinstore servers. Using any social network/copy trade Application for transactions over the Internet may be interrupted, resulting in unexpected losses that may exceed the customer's account balance. Coinstore is not responsible for the performance of the application.",
  ...
  "m3-st-d-s2-d1":
    "After reaching the minimum deposit amount of AUD 5,000, you will be able to enjoy the services provided by DupliTrade's powerful portfolio of leading strategic providers, and will be able to automatically trade on your own MT4 account. If you still want to understand the market, you can also in Practice strategies on your Coinstore account.",
  "m3-st-d-s3-t1": "Start now",
  "m3-st-d-s3-d1":
    "1. If you haven't started the experience, you can open a live trading account</br>2. Create a Duplitrade account through Coinstore<br/>3. Contact us and ask to connect your account to Duplitrade.",
  "m3-st-d-s4-d1":
    "Disclaimer: Duplitrade is a British Virgin Islands registered company and use is subject to the terms and conditions set forth on its website duplitrade.com/terms-and-conditions. Coinstore Group Limited (Coinstore) is not responsible for and has no control over Use signals generated by Duplitrade and trade Coinstore accounts derived therefrom. Signals generated by Duplitrade on Coinstore accounts do not constitute factual, general or personal advice by Coinstore.",
  "m3-st-d-s4-d2":
    "Important Disclaimer: The information and analysis presented here has been produced by Signal Provider, Inc. Coinstore has reproduced this information without alteration or verification and does not represent that this material is accurate, current or complete and should not be relied upon This information. This material is general information and is for informational purposes only and does not take into account any individual's investment objectives, financial solutions or approaches. Coinstore advises clients to seek independent financial advice before considering investing in any signal products and services. In addition, Coinstore reiterates that, Past returns are not indicative of future performance. Readers should also be aware that, like all technological applications, the Internet has inherent weaknesses and operating systems rely on third parties to manage connections to Coinstore servers. Using any social network/copy trade Application for transactions over the Internet may be interrupted, resulting in unexpected losses that may exceed the customer's account balance. Coinstore is not responsible for the performance of the application.",
  ...
  "m3-st-t-c-s1-t2":
    "Enhance your trading with no-code automation. Free for Coinstore customers",
  "m3-st-t-c-s1-d1":
  ...
  "m3-st-t-c-s3-t1": "Free for Coinstore customers",
  "m3-st-t-c-s3-d1": "No registration required",
  "m3-st-t-c-s3-d2":
    "Sign in to Capitalise.ai with your Coinstore MT4 account and you can easily test and automate your trading strategies, no code required.",
  ...
  "m3-st-t-c-s4-2-d1":
    "Log in to Capitalise.ai using your existing Coinstore MetaTrader 4 trading account and password.",
  "m3-st-t-c-s4-2-d2":
  ...
  "m3-st-t-ca-s3-1-t1": "New to Coinstore?",
  ...
  "m3-st-t-ap-s2-t1": "Benefits of using the Coinstore API for transactions",
  ...
  "m3-st-t-ap-s2-d1":
    "Coinstore current account holders with a minimum monthly trading volume of A$250 million can apply for the FIX Coinstore environment to test our FIX functionality.",
  "m3-st-t-ap-s2-d2":
    "If you'd like to discuss API trading, please email support{'@'}Coinstore.com.",
  // "If you'd like to discuss API trading, please email&nbsp;<a href='mailto:support@Coinstore.com'>premium{'@'}Coinstore.com</a>.",
  ...
  "m3-st-t-vp-s2-d1":
    "Enjoy ultra-low latency around 1 millisecond with FXVM. ForexVPS staff is available 24 hours a day in multiple languages to help you install expert advisors, third-party tools, or troubleshoot any issues. Your FXVM will also come pre-installed with Coinstore MetaTrader 4 so you can trade instantly.",
  "m3-st-t-vp-s2-d2": "Get 20% off Coinstore ForexVPS",
  ...
  "m3-st-t-vp-s2-d5": "When you join Coinstore, you will get 25% off any VPS plan.",
  "m3-st-t-vp-s2-d6": "Order your custom Coinstore VPS now",
  ...
  "m3-ms-s2-1-d2":
    "(Live and Coinstore)Saturday, 18th of March from 12:00pm - 14:00pm GMT+2",
  ...
  "m4-mn-a7-c": `<div class="rich-text__container"><h5>Even if you are not directly involved, your pension account will have some stock market exposure. Among the thousands of stocks, you can always find the ones you are familiar with or interested in, and the rise and fall of stock prices and profit and loss are more intuitive and easy to understand than the foreign exchange market. </h5>
   ...
   <h5>Coinstore was founded in Melbourne in 2010 and quickly grew to become one of the largest online trading brokers in the world. At present, we provide customers with nearly a thousand mainstream stocks in the United States, and hundreds of stock CFD transactions in Australia, the United Kingdom and Germany. </h5>
...
<h5>The Australian dollar rose slightly last week due to the rebound in commodity prices such as iron ore and China’s stimulus measures. However, at the moment when the risk sentiment has dropped in an all-round way, the outlook for commodity currencies is still worrying. This week, focus on the support around 0.6720. </h5>`,
  ...
  "m5-wh-10tt-8-q1": "Coinstore Account",
  "m5-wh-10tt-8-a1":
    "We offer Coinstore accounts to all of our clients, replicating a live trading environment and providing traders with virtual starting capital. The Coinstore platform allows traders to learn about the platform, market environment, and charts and execution while trading with virtual funds.<br ></br>Trading on a Coinstore account is a great way to gain confidence in your ability to manage risk, understand appropriate position sizes, and adapt to the unique characteristics of the market. Before opening a real account, it can be A useful tool to practice your trading strategies. Open a Coinstore account today and start trading with virtual funds.",
  ...
  "m5-wh-dq-18-d1": `<div class="rich-text__container"><h5><strong>What is the source of our next day rate for tomorrow? </strong></h5>
    ...
    <h5>Coinstore's long swap rate: -11.49, short swap rate: +7.02</h5>
  ...
  "m5-tg-7-d1":
    "At Coinstore, gold has always been the most popular investment target for traders, and we have been committed to providing you with more updated gold trading products...",
  "m5-tg-7-b1": "Beginner",
  ...
  "m5-tg-a1-s2-10-d1":
    "Trading systems that look good on paper often fall short when they go live.</br></br>Sometimes this is due to poor system design, but often it is due to poor pricing data for backtesting the strategy.</br> </br>Make sure you test the strategy on the same data as the trading strategy. Of course, the same problem occurs when you run the EA on a Coinstore account.",
  ...
  "m5-tg-a3-s1-d1":
    "Coinstore knows that transaction costs are the most important concern of customers, so we have been committed to providing customers with competitive spreads in the industry. By connecting with many top investment banks and liquidity providers, we provide you with the best trading Bid/Ask price.",
  ...
  "m5-tg-a4-s2-c": `<div class="rich-text__container"><!--StartFragment--><h4></br><strong>Which trading products are affected by this</strong> </h4>
   ...
   <h5>The quotations of all stock index products including US500 on the Coinstore platform come from the futures market. The expected future dividend and interest income has been reflected in the quotation model, which is also affected by the circuit breaker mechanism in the underlying market. </h5>
  ...
  "m5-tg-a7-s2-c": `<div class="rich-text__container"><h5>At Coinstore, gold has always been the most popular investment target for traders, and we have been committed to providing you with More updated gold trading products. The most popular gold trade is denominated in US dollars (XAUUSD). But at Coinstore, you can now trade gold in up to <a href="#">5 currencies</a>. This article will introduce you to the advantages of gold denominated in non-US currencies. </h5>
   ...
   <h5>Coinstore offers competitive spreads on the latest gold product launch. The lowest point difference of XAUGBP and XAUCHF is 0.08, and the average point difference is 0.38 and 0.4 respectively. </h5>
   <h3>Translate market readings into trading strategies</h3>
   <h5>Through Coinstore's rich gold trading options, you will have the opportunity to further improve and enrich your trading strategies. When you have a certain expectation on the rise and fall of gold, choose a currency that is most opposite to the trend of gold, and combine the two to form a transaction. Of course, once the market trend is inconsistent with your expectations, it may also increase your losses. </h5>
  ...
  "tv-s1-t1": "Trading on TradingView with Coinstore",
  "tv-s1-d1":
  ...
  "tv-s2-d1":
    "Bring out your technical analyst. Trade over 1,200 instruments on TradingView's advanced and highly customizable charts. Take advantage of Coinstore's transparent pricing, fast execution, and award-winning customer service*.",
  "tv-s2-d2": "Next Generation Chart Technology",
  "tv-s3-t1": "Why choose Coinstore?",
  ...
  "tv-s3-3-d1":
    " Coinstore is an ASIC, FCA, DFSA, CMA, CySEC, BaFin and SCB regulated broker with client funds held in segregated accounts",
  ...
  "tv-s4-3-t1":
    "I'm new to Coinstore, how do I register an account and connect it to TradingView?",
  "tv-s4-3-d1":
    "If you're new to Coinstore, find our step-by-step instructions here.",
  "tv-s4-4-t1":
    "I am an existing Coinstore client, how do I start trading on TradingView?",
  "tv-s4-4-d1":
    "As an existing Coinstore client wishing to start trading on TradingView, please find instructions here.",
  "tv-s4-5-t1": "Can I connect my MT4, MT5 or cTrader account to TradingView?",
  "tv-s4-5-d1": "Only supports Coinstore TradingView accounts.",
  "tv-s4-6-t1": "What is TradingView and how to use it?",
  "tv-s4-6-d1":
    "TradingView is a web-based social network for traders, allowing them to interact and share trading ideas, as well as analyze and trade directly from TradingView's advanced charting capabilities.",
  "tv-s4-7-t1":
    "Will the funds in my Coinstore TradingView account stay with Coinstore or TradingView?",
  "tv-s4-7-d1": "All funds are held in a segregated account at Coinstore.",
  "tv-s4-8-t1": "What does Coinstore TradingView account 'Powered by cTrader' mean?",
  "tv-s4-8-d1":
    "Coinstore TradingView accounts are built on the cTrader platform and are designed specifically to support your trading experience on TradingView.",
  "tv-tip1":
    "*Registered TradingView account holder.</br>^Other fees may apply.",

  //group
  "g-s1-t1": "Welcome to Coinstore Group",
  ...
  "g-s2-t1": "Learn more about the Coinstore Group",
  ...
  "g-s2-2-d1": "Which global Coinstore office best suits your trading needs?",
  "g-s3-1-t1": "About us",
  "g-s3-1-d1":
    "Learn more about Coinstore's advanced technology and our determination to help customers master the transaction.",
  ...
  "ld-s0-d1":
    "Before you open an account with our platform, you should read the legal documents related to the Coinstore entity with which you register your account.",
  "ld-s1-d1":
    "Please note that our legal documentation varies based on the Coinstore entity with which you hold your trading account and which regulations apply to you. The legal documentation applicable to your account will be clearly stated on your application form and you should Read this document carefully before.To learn more about the regulations that apply to you, please click on the relevant link below:",
  "ld-s1-1-q1": "Coinstore Markets Limited (Bahamas)",
  "ld-s1-1-a1": `<div class="rich-text__container"><p>When you open an account with Coinstore Markets Limited, this means that you have read, understood and agreed to the terms in the following documents </p>
  <ul><li><a href="pdf.js/SCB_Client_TCs_ROW.pdf" target="_blank" rel="noreferrer noopener">
  terms and conditions
  </a> –
  This Agreement is intended to govern the relationship between you and Coinstore Markets Limited.
  </li><li><a href="pdf.js/SCB_Privacy_Policy_ROW.pdf" target="_blank" rel="noreferrer noopener">
  Privacy Policy
  </a> –
  This policy sets out how we collect and manage your personal information when you trade with Coinstore Markets Limited.
  </li><li><a href="pdf.js/SCB_Cookie_Policy_ROW.pdf" target="_blank" rel="noreferrer noopener">
  Cookie Policy
  </a> –
  This policy describes the types of cookies we use on www.Coinstore.com/cn/ and how we manage them. Your use of our website constitutes your agreement to the terms set forth in this policy.
  </li><li><a href="#">Coinstore Platform Terms and Conditions</a></li><li><a href="pdf.js/SCB_Risk_Disclosure_Notice_ROW.pdf">
  ...
  "ld-s1-d2":
    "If you have any questions about the documentation or need information in another language, please send a request to support{'@'}Coinstore.com and we will make arrangements for you.",
  ...
  //partner partners
  "p-s0-t1": "Become a Coinstore partner",
  "p-s0-d1":

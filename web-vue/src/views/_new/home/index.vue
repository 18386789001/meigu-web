  ...
  <div class="new-home">
    ...
    <section class="markets-section">
      <div class="container">
        ...
        >
          <el-tab-pane
            :label="$t('newHome.markets.gainers')"
            name="gainers"
          ></el-tab-pane>
          <el-tab-pane
            :label="$t('newHome.markets.hot')"
            name="hot"
          ></el-tab-pane>
          <el-tab-pane
            :label="$t('newHome.markets.labs')"
            name="labs"
          ></el-tab-pane>
        </el-tabs>
        ...
        <div class="markets-content" v-loading="marketLoading">
          ...
          >
            ...
            <el-table-column
              :label="$t('newHome.markets.change24h')"
              width="150"
              align="right"
            >
              <template #default="{ row }">
            ...
            <el-table-column
              :label="$t('newHome.markets.volume24h')"
              prop="volume"
              align="right"
            >
              <template #default="{ row }">
            ...
            <el-table-column
              :label="$t('newHome.markets.action')"
              width="120"
              align="center"
            >
              <template #default="{ row }">
...
const handleRegister = async () => {
  ...
  try {
    ...
    ElMessage.error(t("newHome.hero.registrationFailed"));
...
.hero-section {
  ...
  min-height: calc(100vh - $header-height - 240px);
  display: flex;
  align-items: center;
  position: relative;
  overflow: hidden;

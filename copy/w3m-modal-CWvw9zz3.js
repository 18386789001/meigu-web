import{i as g,a as v,x as l,u as _,R as c,j as w,r as D,H as oe,o as L,m as ie,k as G,L as K,M as h,O as A,C as z,A as q,S as $,D as R,c as ne,h as ae,e as se}from"./index-CWdX713u.js";import{a as U,c as y,n as p,r as d,e as re,b as ce,o as M,U as le,i as de}from"./if-defined-Bmgtyenu.js";import"./index-DUOxw_eN.js";import"./index-BsccQCB1.js";import"./index-CM3h9Wiq.js";import"./index-CxJxYGk7.js";import"./index-DC16DTJV.js";import"./index-D87x7Wfd.js";import"./antd-Bvt8vHIl.js";import"./vendor-DoC2WAmd.js";import"./utils-DJ8lBnJC.js";const ue=g`
  :host {
    display: block;
...
`;var Q=function(s,e,t,i){var n=arguments.length,o=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(a=s[r])&&(o=(n<3?a(o):n>3?a(e,t,o):a(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o};let P=class extends v{constructor(){super(...arguments),this.imageSrc=""}render(){return l`<button>
    ...
    ></wui-icon-box>`}};P.styles=[U,re,ce,fe];Q([p()],P.prototype,"imageSrc",void 0);P=Q([y("wui-select")],P);const be=g`
  :host {
    height: 64px;
  }
...
`;var S=function(s,e,t,i){var n=arguments.length,o=n<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,i);else for(var r=s.length-1;r>=0;r--)(a=s[r])&&(o=(n<3?a(o):n>3?a(e,t,o):a(e,t))||o);return n>3&&o&&Object.defineProperty(e,t,o),o};const F="scroll-lock";let b=class extends v{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=A.state.enableEmbedded,this.open=h.state.open,this.caipAddress=w.state.activeCaipAddress,this.caipNetwork=w.state.activeCaipNetwork,this.shake=h.state.shake,this.filterByNamespace=z.state.filterByNamespace,this.initializeTheming(),R.prefetchAnalyticsConfig(),this.unsubscribe.push(h.subscribeKey("open",e=>e?this.onOpen():this.onClose()),h.subscribeKey("shake",e=>this.shake=e),w.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),w.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),A.subscribeKey("enableEmbedded",e=>this.enableEmbedded=e),z.subscribeKey("filterByNamespace",e=>{var t;this.filterByNamespace!==e&&!((t=w.getAccountData(e))!=null&&t.caipAddress)&&(R.fetchRecommendedWallets(),this.filterByNamespace=e)}))}firstUpdated(){if(this.caipAddress){if(this.enableEmbedded){h.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.cssText=`
    ...
    </wui-card>`}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){c.state.view==="UnsupportedChain"||await K.isSIWXCloseDisabled()?h.shake():h.close()}initializeTheming(){const{themeVariables:e,themeMode:t}=ne.state,i=le.getColorTheme(t);de(e,i)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),$.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){const e=document.createElement("style");e.dataset.w3m=F,e.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
    ...
    `,document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${F}"]`);e&&e.remove()}onAddKeyboardListener(){var t;this.abortController=new AbortController;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("wui-card");e==null||e.focus(),window.addEventListener("keydown",i=>{if(i.key==="Escape")this.handleClose();else if(i.key==="Tab"){const{tagName:n}=i.target;n&&!n.includes("W3M-")&&!n.includes("WUI-")&&(e==null||e.focus())}},this.abortController)}onRemoveKeyboardListener(){var e;(e=this.abortController)==null||e.abort(),this.abortController=void 0}async onNewAddress(e){const t=w.state.isSwitchingNamespace,i=ae.getPlainAddress(e);!i&&!t?h.close():t&&i&&c.goBack(),await K.initializeIfEnabled(),this.caipAddress=e,w.setIsSwitchingNamespace(!1)}onNewNetwork(e){var V,X;const t=this.caipNetwork,i=(V=t==null?void 0:t.caipNetworkId)==null?void 0:V.toString(),n=t==null?void 0:t.chainNamespace,o=(X=e==null?void 0:e.caipNetworkId)==null?void 0:X.toString(),a=e==null?void 0:e.chainNamespace,r=i!==o,C=r&&!(n!==a),W=(t==null?void 0:t.name)===se.UNSUPPORTED_NETWORK_NAME,E=c.state.view==="ConnectingExternal",O=!this.caipAddress,ee=c.state.view==="UnsupportedChain",te=h.state.open;let I=!1;te&&!E&&(O?r&&(I=!0):(ee||C&&!W)&&(I=!0)),I&&c.state.view!=="SIWXSignMessage"&&c.goBack(),this.caipNetwork=e}prefetch(){this.hasPrefetched||(R.prefetch(),R.fetchWalletsByPage({page:1}),this.hasPrefetched=!0)}};b.styles=xe;S([p({type:Boolean})],b.prototype,"enableEmbedded",void 0);S([d()],b.prototype,"open",void 0);S([d()],b.prototype,"caipAddress",void 0);S([d()],b.prototype,"caipNetwork",void 0);S([d()],b.prototype,"shake",void 0);S([d()],b.prototype,"filterByNamespace",void 0);b=S([y("w3m-modal")],b);export{b as W3mModal};

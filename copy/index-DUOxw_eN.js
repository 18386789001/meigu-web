import{i as v,a as b,x as g}from"./index-CWdX713u.js";import{a as h,e as f,b as m,n as l,c as w}from"./if-defined-Bmgtyenu.js";const x=v`
  button {
...
`,g`
    ...
    `}};c.styles=[h,f,m,x];d([l()],c.prototype,"size",void 0);d([l({type:Boolean})],c.prototype,"disabled",void 0);d([l()],c.prototype,"icon",void 0);d([l()],c.prototype,"iconColor",void 0);c=d([w("wui-icon-link")],c);const y=v`
  :host {
    display: flex;
...
`;var p=function(i,o,r,e){var a=arguments.length,t=a<3?o:e===null?e=Object.getOwnPropertyDescriptor(o,r):e,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(i,o,r,e);else for(var s=i.length-1;s>=0;s--)(n=i[s])&&(t=(a<3?n(t):a>3?n(o,r,t):n(o,r))||t);return a>3&&t&&Object.defineProperty(o,r,t),t};let u=class extends b{constructor(){super(...arguments),this.variant="main",this.size="lg"}render(){this.dataset.variant=this.variant,this.dataset.size=this.size;const o=this.size==="md"?"mini-700":"micro-700";return g`
      <wui-text data-variant=${this.variant} variant=${o} color="inherit">
        <slot></slot>
      </wui-text>
    `}};u.styles=[h,y];p([l()],u.prototype,"variant",void 0);p([l()],u.prototype,"size",void 0);u=p([w("wui-tag")],u);

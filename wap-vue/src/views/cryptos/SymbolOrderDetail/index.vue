    ...
    <div class="tradeDetail">
      ...
      <div class="pl-8 pr-8 pt-10 pb-14">
        ...
        <div class="flex justify-between pb-16">
          ...
          <div class="textColor">{{ detail.volume ?? '--' }}</div>
        </div>
        <div class="flex justify-between pb-16">
        ...
        <div class="flex justify-between pb-16" v-if="detail.profit !== undefined">
          <div class="text-grey">{{ $t('盈亏金额') }}</div>
          <div class="textColor" :class="detail.profit >= 0 ? 'text-green' : 'text-red'">

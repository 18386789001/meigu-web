<template>
  <div class="futures-buy-container">
    <van-nav-bar
      :title="t('期货买入')"
      left-arrow
      ...
      <div class="form-section">
        <van-form @submit="onSubmit">
          <van-field
            ...
            :label="t('数量')"
            type="number"
            :placeholder="t('请输入买入数量')"
            :rules="[{ required: true, message: t('请输入买入数量') }]"
          />
          ...
          <van-field
            ...
            :label="t('价格')"
            type="number"
            :placeholder="t('请输入买入价格')"
            :rules="[{ required: true, message: t('请输入买入价格') }]"
          />

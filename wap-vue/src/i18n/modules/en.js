export default {
    '已自动兑换为usdt': 'Automatically converted to USDT',
    'ethConvertedToUsdtNotice': 'ETH converted to USDT',
    ...
    // Futures trading related translations
    ...
    'nickel': 'Nickel',
    // 能源品种
    'spotBrent': 'Spot Brent Crude Oil',
    'natGas': 'Natural Gas',
    'gasoline': 'Gasoline',
    // 软商品品种
    'coffee': 'Coffee',
    ...
    '未找到相关商品': 'No related commodities found',
    '清空搜索': 'Clear Search',
    '高': 'High',
    '低': 'Low',
    '开': 'Open',
    ...
    '关于JPMX': 'About JPMX',
    'about_jpmx_intro': 'We are a global investment company dedicated to creating greater possibilities for our clients.',
    '投资理念': 'Investment Philosophy',
    'about_investment_philosophy': 'Guided by Deccan Value Investors L.P., JPMX adheres to a stable investment philosophy, combining deep understanding of market dynamics with a focus on stable returns. Our fundamental analysis-based approach enables us to identify undervalued opportunities and dynamically adjust portfolios to capture emerging trends.',
    '追求卓越': 'Pursuit of Excellence',
    'about_pursuit_excellence': 'The core of JPMX is the relentless pursuit of excellence. Our reputation for diligence and integrity reinforces our commitment to maintaining the highest standards in the financial industry. We uphold transparency, accountability, and building lasting trust-based relationships.',
    '全球市场影响力': 'Global Market Influence',
    'about_global_market_influence': 'JPMX possesses global market influence. Our business operations span various industries and regions, allowing us to seize extensive investment opportunities. This global perspective enables us to respond to market fluctuations and capture emerging trends.',
    '客户成功案例': 'Client Success Stories',
    'about_client_success': 'JPMX takes pride in our client success stories. From institutional investors to high-net-worth individuals, our tailored investment solutions help them achieve their financial goals. Our client-centric approach ensures personalized attention and customized strategies for each investor.',
    '创新与适应性': 'Innovation and Adaptability',
    'about_innovation_adaptability': 'In a rapidly changing financial landscape, JPMX considers innovation and adaptability as cornerstones of our success. Our forward-thinking approach ensures we stay ahead of market trends and make informed investment decisions using cutting-edge technology and analytical tools.',
    '社会责任': 'Social Responsibility',
    'about_social_responsibility': 'Beyond financial success, JPMX is deeply aware of our social responsibilities. We actively practice responsible investment, integrating Environmental, Social, and Governance (ESG) factors into our decision-making processes to build sustainable and ethical investment portfolios.',
    'JPMX公司总部': 'JPMX Company Headquarters',
    '公司名称': 'Company Name',
    '街道地址': 'Street Address',
    '城市': 'City',
    '州': 'State',
    ...
    '格林威治': 'Greenwich',
  '康涅狄格州': 'Connecticut',
  'company_name_value': 'Metapoly Ltd.',
  'street_address_value': 'One Fawcett Place',
  // About Us static page
  '全球数字资产金融服务平台': 'Global Digital Asset Financial Services Platform',
  '平台简介': 'Platform Overview',
  '全球化发展': 'Global Expansion',
  '产品与服务': 'Products & Services',
  '核心团队': 'Core Team',
  '安全与合规': 'Security & Compliance',
  '使命愿景': 'Mission & Vision',
  'about_static_p1': 'JPMX is a global digital asset financial services platform, incorporated in the BVI and duly registered as an MSB with the U.S. FinCEN and Canada FINTRAC. Since inception, we adhere to the philosophy of compliance first, security-driven, and innovation-led, providing a secure, intelligent, fair and transparent investment environment for users worldwide.',
  'about_static_p2': 'Since its establishment, JPMX has grown rapidly, serving over 8 million registered users across more than 150 countries and regions, with business presence in Asia, North America, Europe, the Asia-Pacific, and the Middle East. Both individual and institutional clients enjoy efficient, liquid, and professional trading experiences on the platform.',
  'about_static_p3': 'JPMX offers spot trading, derivatives trading, staking, liquidity pools and robo-advisory, meeting full-spectrum needs from basic investment to professional asset management. Our self-developed high-performance matching engine supports million-level TPS for low latency and high reliability, empowering quant funds and market makers.',
  'about_static_p4': 'Our core team comes from top Wall Street banks, Microsoft, Google, and leading crypto firms, with deep expertise in derivatives trading, blockchain R&D, and global market operations. We excel in fund security, risk control, liquidity building, and cross-border compliance.',
  'about_static_p5': 'We implement fund surveillance, multi-signature, and 24/7 intelligent risk systems, strictly following KYC/AML standards and local regulations in each jurisdiction. We actively pursue compliance qualifications in the EU, Singapore, Hong Kong, Japan, and beyond to ensure lawful global operations.',
  'about_static_p6': 'Driven by compliance, security, and innovation, JPMX promotes deep integration of digital assets with traditional finance. We provide efficient services and build long-term partnerships to create a fair, transparent, and intelligent ecosystem. Looking ahead, we will expand our global footprint, optimize products and architecture, and enhance user experience to become a leading global digital finance infrastructure.',
  
  // Help Center page translations
  '常见问题': 'FAQ',
  'help_faq_content': 'Frequently Asked Questions',
  'help_faq_detail_content': '<p><strong>Q: How to register an account?</strong></p><p>A: Click the register button, fill in your email and password to complete registration.</p><br><p><strong>Q: What to do if I forgot my password?</strong></p><p>A: Click "Forgot Password" on the login page and reset your password through email verification code.</p><br><p><strong>Q: How to complete identity verification?</strong></p><p>A: Go to Personal Center, click Identity Verification, and upload your ID photo.</p>',
  
  '账户安全': 'Account Security',
  'help_account_security_content': 'Account Security Protection Guide',
  'help_account_security_detail_content': '<p><strong>Password Security</strong></p><p>• Use strong passwords with letters, numbers and special characters</p><p>• Change passwords regularly</p><p>• Do not enter passwords in public places</p><br><p><strong>Two-Factor Authentication</strong></p><p>• Enable Google Authenticator</p><p>• Enable SMS verification</p><p>• Bind secure email</p><br><p><strong>Security Tips</strong></p><p>• Do not trade on public WiFi</p><p>• Regularly check login records</p><p>• Contact customer service immediately if abnormalities are found</p>',
  
  '交易指南': 'Trading Guide',
  'help_trading_guide_content': 'Digital Currency Trading Operation Guide',
  'help_trading_guide_detail_content': '<p><strong>Start Trading</strong></p><p>• Complete identity verification</p><p>• Deposit digital currency to account</p><p>• Choose appropriate trading pairs</p><br><p><strong>Trading Types</strong></p><p>• Spot Trading: Instant buy/sell</p><p>• Futures Trading: Leveraged trading</p><p>• Dollar Cost Averaging: Regular fixed-amount investment</p><br><p><strong>Trading Tips</strong></p><p>• Set stop-profit and stop-loss</p><p>• Diversify investments to reduce risk</p><p>• Pay attention to market dynamics</p>',
  
  '充值提现': 'Deposit & Withdrawal',
  'help_deposit_withdraw_content': 'Fund Deposit and Withdrawal Instructions',
  'help_deposit_withdraw_detail_content': '<p><strong>Deposit Methods</strong></p><p>• Bank Card Deposit: Supports major bank cards</p><p>• Digital Currency Deposit: Supports BTC, ETH and other major currencies</p><p>• Third-party Payment: Supports Alipay, WeChat Pay</p><br><p><strong>Withdrawal Instructions</strong></p><p>• Withdrawal requires identity verification</p><p>• Withdrawal fees are charged proportionally</p><p>• Withdrawal processing time: 1-24 hours</p><br><p><strong>Important Notes</strong></p><p>• Please carefully verify deposit addresses</p><p>• Confirm payment information before withdrawal</p><p>• Large withdrawals require manual review</p>',
  
  '技术支持': 'Technical Support',
  'help_technical_support_content': 'Technical Issue Solutions',
  'help_technical_support_detail_content': '<p><strong>Common Technical Issues</strong></p><p>• Page cannot load: Check network connection, clear browser cache</p><p>• Trading failed: Check if balance is sufficient, network is stable</p><p>• Verification code not received: Check if phone number is correct, contact customer service</p><br><p><strong>Browser Compatibility</strong></p><p>• Recommended: Latest versions of Chrome, Firefox, Safari</p><p>• Ensure JavaScript is enabled</p><p>• Disable ad blocking plugins</p><br><p><strong>Contact Information</strong></p><p>• Online Customer Service: 7x24 hours</p><p>• Email Support: support@jpmx.com</p><p>• Phone Support: 400-123-4567</p>',
  
  // Terms of Service page translations
  '服务条款': 'Terms of Service',
  '重要提醒': 'Important Reminder',
  'service_terms_reminder': 'We would like to remind you:',
  '数字资产风险': 'Digital Asset Risks',
  'service_terms_risk_1': '1. Digital assets are not issued by any financial institution, company, or website.',
  'service_terms_risk_2': '2. The digital asset market is new, unverified, and likely to remain stagnant.',
  'service_terms_risk_3': '3. Digital assets are primarily used by speculators, with relatively little use in the retail and commercial markets. Trading digital assets carries significant risks. They trade continuously throughout the day, with no price limits, and prices are susceptible to significant fluctuations due to market manipulation and global government policies.',
  'service_terms_risk_4': '4. Digital asset trading carries a high level of risk and is not suitable for most people. You acknowledge and understand that such trading may result in partial or total loss, so you should determine the transaction amount based on your ability to withstand losses.',
  '账户管理': 'Account Management',
  'service_terms_account': 'If the Company, in its sole discretion, determines that you have violated this Agreement, or that the services provided by this website or your use of the services is illegal under the laws of your jurisdiction, the Company reserves the right to suspend or terminate your account, or your use of the services provided by this website or digital asset trading, at any time.',
  '交易风险': 'Trading Risks',
  'service_terms_trading_risk': 'You acknowledge and understand that digital assets carry inherent risks. In addition to the risks mentioned above, there are also unforeseen risks.',
  '风险承担': 'Risk Assumption',
  'service_terms_risk_assumption': 'You should carefully consider and use clear judgment to assess your own financial situation and the above risks before making any transactions.',
  '专业建议': 'Professional Advice',
  'service_terms_professional_advice': 'If you have any questions, we recommend that you seek professional advice.',
  ...
  'ZCUSD': 'Corn',
    ...
    '撤单': 'Cancel',
    '确认平仓': 'Confirm Close',
    '确定要平仓这个持仓吗？': 'Are you sure to close this position?',
    '平仓成功': 'Position closed successfully',
    '功能开发中': 'Feature under development',
    '确认撤单': 'Confirm Cancel',
    '确定要撤销这个委托吗？': 'Are you sure to cancel this order?',
    ...
    'K线图表': 'K-Line Chart',
    '点击查看K线图表': 'Click to view K-Line Chart',
    'K线图表功能': 'K-Line Chart Function',
    ...
    '杠杆倍数越高风险越大，请谨慎选择合适的杠杆倍数': 'Higher leverage means higher risk, please choose appropriate leverage carefully',
    '永续合约风险过高，杠杆最大为10倍！': 'Perpetual contract risk is too high, maximum leverage is 10x!',
    '确认': 'Confirm',
    '杠杆调整成功': 'Leverage adjusted successfully',

    // Futures related translations
    '期货综合': 'Futures Composite',
    '金属': 'Metals',
    '合约': 'Contract',
    '最新': 'Latest',
    ...
    '确认买入': 'Confirm Buy',
    '确认卖出': 'Confirm Sell',
    '买入订单已提交': 'Buy order submitted',
    '卖出订单已提交': 'Sell order submitted',
    '请输入买入数量': 'Please enter buy quantity',
    '请输入买入价格': 'Please enter buy price',
    '请输入卖出数量': 'Please enter sell quantity',
    '请输入卖出价格': 'Please enter sell price',
    ...
    '市值': 'Market Value',
    '盈亏': 'P&L',
    '持仓/可用': 'Position/Available',
    '成本/现价': 'Cost/Current',
    '暂无记录': 'No Records',
    'long': 'Long',
    'short': 'Short',

    // Leverage adjustment modal translations
    '当前杠杆倍数最高可开': 'Maximum position with current leverage',
    ...
    uploadIdPhotos: "Please upload your ID photos first",
    ...
    "期货": "Futures",
    "期货综合": "Futures Composite",
    "期权综合": "Options Composite",
    "国内行情": "Domestic Market",
    "国外行情": "International Market",
    "金属": "Metals",
    "黑色金属": "Ferrous Metals",
    ...
    "原油": "Crude Oil",
    "燃油": "Fuel Oil",
    "10年期国债": "10-Year Treasury Bond",
    "5年期国债": "5-Year Treasury Bond",
    "上证50指数": "SSE 50 Index",
    ...
    "亿": "B",
    "billionUSD": "B USD",
    "tenThousandUSD": "W USD", 
    "thousandUSD": "K USD",
    "fixedTradingVolume": "922.34B USD",
    "trillionUSD": "T USD",
    "hundredBillionUSD": "100B USD",
    "ton": "tons",
    "thousandTons": "K tons",
    "millionBarrels": "M barrels",
    "thousandBarrels": "K barrels",
    "barrels": "barrels",
    "hundredMillionCubicMeters": "B m³",
    "tenThousandCubicMeters": "W m³",
    "cubicMeters": "m³",
    "tenThousandBoardFeet": "W bf",
    "boardFeet": "bf",
    "成交额": "Volume",
...
"loanRuleTitle1":"1. What is A/D INVESTORS FUND LP Loan?",
   '外汇合约':'Foreign Delivery',
    ...
    '未绑定谷歌验证器，暂时无法提现，点击前往绑定': 'Google Authenticator not bound, withdrawal temporarily unavailable, click to bind',
    '请输入谷歌验证码': 'Please enter Google verification code',
    '需要绑定谷歌验证器才可以提现': 'Google Authenticator must be bound to withdraw',
    '请输入试用码': 'Please enter trial code',
    '试用账号申请': 'Trial Account Application',
    '试用码': 'Trial Code',
    '点此联系客服': 'Click here to contact customer service',
    '取得试用码': 'Get Trial Code',
    '试用账户': 'Trial Account',
    '白天模式': 'Day Mode',
    '黑夜模式': 'Night Mode',
    '需要绑定邮箱和手机才可以提现': 'Email and phone must be bound to withdraw',
    ...
    // News translation related
    '正在翻译新闻内容...': 'Loading...',
    '已翻译': 'Translated',
    '没有更多了': 'No more data',
    '加载中...': 'Loading...',
    '暂无新闻数据': 'No news data available',
    '重新加载': 'Reload',
    '最新财经新闻': 'Latest Financial News',
    ...
    '。': '.',
    // 登录状态相关
    '您的账号已过期或已在其他设备登录，请重新登录': 'Your account has expired or has been logged in on another device, please log in again',
    '登录状态已过期，请重新登录': 'Login status has expired, please log in again',
    // 网络错误相关
    'Request failed with status code 405': 'Request failed with status code 405',
    ...
    'Network Error': 'Network Error',
    // 支付方式相关
    '暂无可用的支付方式': 'No available payment methods',
    '请联系管理员配置支付方式': 'Please contact administrator to configure payment methods',
    '请选择一种支付方式': 'Please select a payment method',
    '选择的支付方式无效': 'Selected payment method is invalid',
    '确认选择': 'Confirm Selection',
    
    // Help Center page translations
    '常见问题': 'FAQ',
    'help_faq_content': 'Frequently Asked Questions',
    'help_faq_detail_content': '<p><strong>Q: How to register an account?</strong></p><p>A: Click the register button, fill in email and password to complete registration.</p><br><p><strong>Q: What if I forgot my password?</strong></p><p>A: Click "Forgot Password" on the login page, reset password through email verification code.</p><br><p><strong>Q: How to do identity verification?</strong></p><p>A: Go to personal center, click identity verification, upload ID photo.</p>',
    
    '账户安全': 'Account Security',
    'help_account_security_content': 'Account Security Protection Guide',
    'help_account_security_detail_content': '<p><strong>Password Security</strong></p><p>• Use strong passwords with letters, numbers and special characters</p><p>• Change passwords regularly</p><p>• Don\'t enter passwords in public places</p><br><p><strong>Two-Factor Authentication</strong></p><p>• Enable Google Authenticator</p><p>• Enable SMS verification</p><p>• Bind secure email</p><br><p><strong>Security Tips</strong></p><p>• Don\'t trade on public WiFi</p><p>• Check login records regularly</p><p>• Contact customer service immediately if anomalies are found</p>',
    
    '交易指南': 'Trading Guide',
    'help_trading_guide_content': 'Digital Currency Trading Operation Guide',
    'help_trading_guide_detail_content': '<p><strong>Start Trading</strong></p><p>• Complete identity verification</p><p>• Deposit digital currency to account</p><p>• Choose appropriate trading pair</p><br><p><strong>Trading Types</strong></p><p>• Spot trading: instant buy/sell</p><p>• Contract trading: leveraged trading</p><p>• DCA: regular fixed investment</p><br><p><strong>Trading Tips</strong></p><p>• Set take profit and stop loss</p><p>• Diversify investment to reduce risk</p><p>• Pay attention to market trends</p>',
    
    '充值提现': 'Deposit & Withdrawal',
    'help_deposit_withdraw_content': 'Fund Deposit & Withdrawal Operation Instructions',
    'help_deposit_withdraw_detail_content': '<p><strong>Deposit Methods</strong></p><p>• Bank card deposit: supports major bank cards</p><p>• Digital currency deposit: supports BTC, ETH and other major currencies</p><p>• Third-party payment: supports Alipay, WeChat Pay</p><br><p><strong>Withdrawal Instructions</strong></p><p>• Withdrawal requires identity verification</p><p>• Withdrawal fees charged proportionally</p><p>• Withdrawal arrival time: 1-24 hours</p><br><p><strong>Precautions</strong></p><p>• Check deposit address carefully</p><p>• Confirm recipient information before withdrawal</p><p>• Large withdrawals require manual review</p>',
    
    '技术支持': 'Technical Support',
    'help_technical_support_content': 'Technical Issue Solutions',
    'help_technical_support_detail_content': '<p><strong>Common Technical Issues</strong></p><p>• Page won\'t load: check network connection, clear browser cache</p><p>• Trading failed: check if balance is sufficient, network is stable</p><p>• Verification code not received: check if phone number is correct, contact customer service</p><br><p><strong>Browser Compatibility</strong></p><p>• Recommend using latest versions of Chrome, Firefox, Safari</p><p>• Ensure JavaScript is enabled</p><p>• Disable ad blockers</p><br><p><strong>Contact Information</strong></p><p>• Online customer service: 7x24 hours service</p><p>• Email support: support@jpmx.com</p><p>• Phone customer service: 400-123-4567</p>',

<template>
  <div class="relative z-30 footer" :class="[{ 'locale-ja': isJa }]">
...
const isJa = computed(() => String(locale.value || '').toLowerCase().startsWith('ja'))
...
/* Japanese locale tweaks: keep icons aligned and shrink long labels */
.footer.locale-ja {

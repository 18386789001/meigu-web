  ...
  data() {
    return {
      ...
      pathList: {
        ...
        'forex': {
          [this.$t('买入')]: '/foreign/deliveryContract/XAUUSD',
          [this.$t('卖出')]: '/foreign/deliveryContract/XAUUSD',
        ...
        'MY-stocks': {
          [this.$t('买入')]: '/quotes/openTrade?tabActive=0&symbol=MYX:3A&type=MY-stocks',
          [this.$t('卖出')]: '/quotes/openTrade?tabActive=1&symbol=MYX:3A&type=MY-stocks',
          // [this.$t('撤单')]: '/quotes/openTrade?tabActive=2&symbol=00139&from=trade&type=MY-stocks',
          [this.$t('持仓')]: '/quotes/openTrade?tabActive=3&symbol=MYX:3A&type=MY-stocks',
          [this.$t('查询')]: '/quotes/openTrade?tabActive=4&symbol=MYX:3A&type=MY-stocks',
        },
        'DE-stocks': {
